...
\usepackage{xpatch}
\usepackage{latexsym}
\usepackage{times, epsfig, amsmath, amssymb}
...
%\vol{98}
%\SpecialIssue{}
\SpecialSection{Information and Communication System Security}
%\theme{Against Cyberattacks}
% \title{Identification of Kernel Memory Corruption Using Kernel Memory Secret Observation Mechanism}
\title{Protection Mechanism of Kernel Data Using Memory Protection Key}
%\title{KMO : Kernel Memory Observer to Identify Memory Corruption \\by Secret Inspection Mechanism}
%\titlenote{}
\authorlist{% fill arguments of \authorentry, otherwise error will be caused. 
%  \authorentry[kuzuno@s.okayama-u.ac.jp]{Hiroki KUZUNO}{m}{SECOM, OKAYAMA}
\authorentry[kuzuno@port.kobe-u.ac.jp]{Hiroki KUZUNO}{m}{KOBE}
\authorentry[yamauchi@okayama-u.ac.jp]{Toshihiro YAMAUCHI}{m}{OKAYAMA}
...
%\affiliate[SECOM]{SECOM Co., Ltd. Mitaka, Tokyo 181--8528, Japan}
...
%\affiliate[IGCI]{INTERPOL Global Complex for Innovation, Singapore}
...
\begin{keywords}
  Memory Corruption, Memory Protection, System Security, Operating System
\end{keywords}

\footnotetext[0]{This paper is an extended version of a paper published
  in the 16th International Workshop on Security (IWSEC) 2022 \cite{kuzuno22iwsec}.}  

\input{contents/introduction}

\input{contents/background}

\input{contents/threatmodel}
...
\begin{thebibliography}{99}
  ...
  % \doi{https://doi.org/10.1007/978-3-031-15255-9\_4} (2022).    
...
\bibitem{cve}
  ...
  % Exploit Database, Nexus 5 Android 5.0 - Privilege Escalation. \url{https://www.exploit- db.com/exploits/35711/}. Accessed 21 May 2019    
  % Nexus 5 Android 5.0 - Privilege Escalation, Exploit Database (online), \urle{https://www.exploit-db.com/exploits/35711/} \refdatee{2019-05-21}. %(accessed 2019-05-21).%Accessed 21 May 2019       
...
\bibitem{grsecurity}
  ...
  % grsecurity: super fun 2.6.30+/RHEL5 2.6.18 local kernel exploit (online), \urle{https://grsecurity.net/~spender/exploits/exploit2.txt} \refdatee{2019-05-21}.%(accessed 2019-05-21).  
...
\bibitem{abadi05ccs}
  ...
  % Abadi, M., Budiu, M., Erlingsson, U. and Ligatti, J.: Control-flow integrity principles, implementations, and applications. \textit{Proc. the 12th ACM Conference on Computer and Communications Security}, pp. 340--353 (online), \doi{https://doi.org/10.1145/1609956.1609960} (2005).
...
\bibitem{criswell14sp}
 ...
 Shacham, H., Page, M., Pfaff, B., Goh, E., Modadugu, N. and Boneh, D.: On the effectiveness of address-space randomization, the 11th ACM Conference on Computer and Communications Security (CCS), pp. 298--307, (2004).
  ...
  % Shacham, H., Page, M., Pfaff, B., Goh, E., Modadugu, N. and Boneh, D.: On the effectiveness of address-space randomization. \textit{Proc. the 11th ACM Conference on Computer and Communications Security}, pp. 298--307 (online), \doi{https://doi.org/10.1145/1030083.1030124} (2004)
  ...
  % Yamauchi, T., Akao, Y., Yoshitani, R, Nakamura, Y., Hashimoto M.: Additional kernel observer: privilege escalation attack prevention mechanism focusing on system call privilege changes. \textit{International Journal of Information Security}, vol. 20, no. 13, pp. 461--473 (online), \doi{https://doi.org/10.1007/s10207-020-00514-7} (2021).
  ...
  \bibitem{cwe}
  % Common Weakness Enumeration: MITRE (online), \urle{https://cwe.mitre.org/} \refdatee{2022-08-18}.
...
\bibitem{qemu}
    ...
    % Bonzini, P.: [PATCH] target/i86: implement PKS. \urle{https://lore.kernel.org/qemu-devel/20210127093540.472624-1\\-pbonzini@redhat.com/}. \refdatee{2021-08-18}.
...
\bibitem{intel-mpk}
  ...
  % Intel(R) 64 and IA-32 Architectures Software Developer’s Manual: Intel Corporation (online), \urle{https://www.intel.com/content/www/us/en/developer/articles/\\technical/intel-sdm.html} \refdatee{2021-08-18}.
  ...
  Chen, H., Mao, Y., Wang, X., Zhow, D., Zeldovich, N. and Kaashoek, F, M.: Linux kernel vulnerabilities - state-of-the-art defenses and open problems, the 2nd Asia-Pacific Workshop on Systems (APSys), (2011).
    ...
    % Chen, H., Mao, Y., Wang, X., Zhow, D., Zeldovich, N. and Kaashoek, F, M.: Linux kernel vulnerabilities - state-of-the-art defenses and open problems. \textit{Proc. the Second Asia-Pacific Workshop on Systems}, pp. 1--5 (online), \doi{https://doi.org/10.1145/2103799.2103805} (2011).
  ...
  % CVE-2016-4997: NIST (online), \urle{https://nvd.nist.gov/vuln/detail/CVE-2016-4997} \refdatee{2021-09-16}.
...
\bibitem{CVE-2016-9793}
  ...
  % CVE-2016-9793: NIST (online),  \urle{https://nvd.nist.gov/vuln/detail/CVE-2016-9793} \refdatee{2021-09-16}.
...
\bibitem{CVE-2017-16995}
  ...
  % CVE-2017-16995: NIST (online),  \urle{https://nvd.nist.gov/vuln/detail/CVE-2017-16995} \refdatee{2021-09-16}.
  %CVE-2017-16995,
...
\bibitem{CVE-2017-1000112}
  ...
  % CVE-2017-1000112: NIST (online), \urle{https://nvd.nist.gov/vuln/detail/CVE-2017-1000112} \refdatee{2021-09-16}.
...
\bibitem{erim}
  ...
  % Vahldiek-Oberwagner, A., Elnikety, E., Duarte, O., N., Sammier, M., Druschel, P., Garg, D.: ERIM: Secure, Efficient In-process Isolation with Protection Keys (MPK). \textit{Proc. the 28th USENIX Conference on Security Symposium}, pp. 1221--1238 (online), \doi{https://dl.acm.org/doi/10.5555/3361338.3361423} (2019). 
...
% Voulimeneas, A., Vinck, J., Mechelinck, R., Volckaert, S.: You shall not (by)pass!: practical, secure, and fast PKU-based sandboxing.
% \textit{Proc. the Seventeenth European Conference on Computer Systems}, pp. 266–-282 (online), \doi{https://doi.org/10.1145/3492321.3519560} (2022).
...
\bibitem{xmp}
  ...
  % Proskurin, S., Momeu, M., Ghavamnia, S., Kemerlis, P., V., Polychronakis, M.: xMP: Selective Memory Protection for Kernel and User Space.
  % \textit{Proc. the 2020 IEEE Symposium on Security and Privacy}, pp. 563--577 (online),  \doi{https://doi.org/10.1109/SP40000.2020.00041} (2020).
...
\bibitem{libhermitmpk}
  ...
  % \textit{Proc. the 16th ACM SIGPLAN/SIGOPS International Conference on Virtual Execution Environments}, pp. 143--156 (online), \doi{https://doi.org/10.1145/3381052.3381326} (2020).
  ...
  % \textit{Proc. the 2020 USENIX Annual Technical Conference}, pp. 401--417 (online), \doi{https://dl.acm.org/doi/10.5555/3489146.3489173} (2020).
  ...
  % \textit{Proc. 2010 IEEE Symposium on Security and Privacy}, pp 380-–395 (online), \doi{https://doi.org/10.1109/SP.2010.30} (2010).
  ...
  % \textit{Proc. the 2016 IEEE European Symposium on Security and Privacy}, pp. 179-–194 (online), \doi{https://doi.org/10.1109/EuroSP.2016.24} (2016).
  ...
  % Control-flow integrity for the kernel: Edge, J., (online), \urle{https://lwn.net/Articles/810077/}. \refdatee{2022-01-08}.
  ...
  % Linux Vulnerability Statistics: CVE details (online), \urle{https://www.cvedetails.com/vendor/33/Linux.html}. \refdatee{2019-07-05}.
